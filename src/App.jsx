                        ...
                        <div className="flex items-center gap-1">
                            ...
                            >
                                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="text-sky-400">
                                    <path d="M9.04 15.59l-.38 5.39c.55 0 .79-.24 1.07-.52l2.57-2.46 5.32 3.9c.98.54 1.68.25 1.94-.9l3.52-16.5h.01c.31-1.46-.53-2.03-1.47-1.67L1.16 9.88c-1.4.54-1.38 1.32-.24 1.67l5.41 1.69 12.6-7.95c.59-.38 1.12-.17.68.21" />
                                </svg>
                            </a>
                            <a
                            ...
                            >
                                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="text-white">
                                    <path d="M18.244 2H21.5l-7.59 8.67L22.5 22h-6.39l-5-6.05L5 22H1.74l8.13-9.29L2 2h6.48l4.54 5.48L18.24 2zm-1.12 18h1.74L8.96 4H7.1l10.03 16z" />
                                </svg>
                            </a>
                            <a
